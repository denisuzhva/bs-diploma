...
\imgh{16cm}{b_eta/bEta}{График зависимости $b$ от $\eta$ с учётом (Fusion) и без учёта (No Fusion) слияния струн (С++, 10000 симуляций)}{bEta}
\imgh{16cm}{b_eta/bEtaScaled}{Отмасштабированный по оси $b$ график зависимости $b$ от $\eta$ с учётом (Fusion) и без учёта (No Fusion) слияния струн (С++, 10000 симуляций)}{bEtaScaled}
\imgh{16cm}{b_eta/bEtaConstN}{График зависимости $b$ от $\eta$ при $N = \langle N \rangle$ со слиянием (С++, 10000 симуляций)}{bEtaConstN}
\imgh{16cm}{b_eta/bEtaConstNScaled}{Отмасштабированный по оси $b$ график зависимости $b$ от $\eta$ при $N = \langle N \rangle$ со слиянием (С++, 10000 симуляций)}{bEtaConstNScaled}
%%%
\subsection{Таблицы}
{\footnotesize
